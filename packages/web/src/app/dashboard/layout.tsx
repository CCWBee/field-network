...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-paper-warm">
      {/* Navigation */}
      <nav className="bg-paper border-b border-ink-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-14">
            <div className="flex items-center space-x-8">
              ...
              <MobileNav
                ...
                footer={
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 text-signal-red hover:bg-red-50 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/dashboard" className="text-ink-900 font-bold tracking-tight">
                Field Network
              </Link>
              ...
              <div className="hidden lg:flex items-center space-x-1">
                {[
                  { href: '/dashboard/requester', label: 'My Tasks' },
                  { href: '/dashboard/requester/new', label: 'Create Task' },
                  { href: '/dashboard/worker', label: 'Browse' },
                  { href: '/dashboard/worker/claims', label: 'Claims' },
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              >
                {(user?.ensAvatarUrl || user?.avatarUrl) ? (
                  ...
                  <div className="w-7 h-7 rounded-full bg-field-50 flex items-center justify-center text-field-600 font-medium text-xs border border-ink-200">
              ...
              <button
                onClick={handleLogout}
                className="text-ink-500 hover:text-signal-red text-sm transition-colors"
              >
                Logout
              </button>
            </div>
