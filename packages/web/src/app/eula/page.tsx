  ...
  return (
    <div className="min-h-screen bg-surface py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-semibold text-slate-800">End User License Agreement</h1>
        <p className="text-slate-500 mt-2">Full software license terms for Field Network.</p>
